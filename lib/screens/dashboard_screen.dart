      ...
      body: Consumer<HealthDataController>(
        builder: (context, data, _) {
          return NotificationListener<OverscrollIndicatorNotification>(
            ...
            child: ListView(
              physics: const ClampingScrollPhysics(), // Prevents iOS bounce
              ...
              children: [
                    ...
                    children: [
                      ...
                      ClipRRect(
                        ...
                        child: LinearProgressIndicator(
                          value: (data.sleepHours / data.sleepGoal)
                              .clamp(0.0, 1.0),
                          minHeight: 12,
                      ...
                      Row(
                        ...
                        children: [
                          Icon(
                            data.sleepGoal - data.sleepHours <= 0
                                ? Icons.check_circle
                                : Icons.bedtime,
                            color: Colors.white,
                            size: 18,
                          ...
                          Text(
                            data.sleepGoal - data.sleepHours <= 0
                                ? 'Sleep goal achieved! 😴'
                                : '${(data.sleepGoal - data.sleepHours).toStringAsFixed(1)}h more to goal',
                            style: GoogleFonts.inter(
                              fontSize: 14,
                ...
                Container(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      onTap: () {
                        // Show log sleep dialog
                        _showAddSleepDialog(data);
                      },
                      borderRadius: BorderRadius.circular(20),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
